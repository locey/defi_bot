...
interface CompoundUSDTBuyModalProps {
  isOpen: boolean
  onClose: () => void
  onSuccess?: () => void
}
 ...
 * 6. 交易状态反馈
 */
export default function CompoundUSDTBuyModal({ isOpen, onClose, onSuccess }: CompoundUSDTBuyModalProps) {
        ...
        <div className="p-6 pb-4">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">在 Compound 赚取利息收益</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 mb-6">
            <div className={`flex-1 h-1 rounded-full transition-colors ${
              step === 'input' ? 'bg-green-500' :
              step === 'approve' ? 'bg-yellow-500' :
              step === 'supply' ? 'bg-blue-500' :
              'bg-green-500'
            }`} />
            <div className={`flex-1 h-1 rounded-full transition-colors ${
            ...
            <div className={`flex-1 h-1 rounded-full transition-colors ${
              step === 'supply' || step === 'success' ? 'bg-blue-500' : 'bg-gray-700'
            }`} />
            <div className={`flex-1 h-1 rounded-full transition-colors ${
          ...
          {step === 'input' && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 px-2 py-1 bg-green-500/20 text-green-400 rounded text-xs hover:bg-green-500/30 transition-colors"
              ...
              <button
                ...
                className="w-full py-3 bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700 disabled:from-gray-600 disabled:to-gray-700 text-white font-semibold rounded-lg transition-all flex items-center justify-center gap-2"
              >
                {isOperating ? (
                  <>
            ...
            <div className="space-y-4">
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-400">
                  正在授权 {amount} USDT 给 CompoundAdapter 合约
                </p>
              </div>
            </div>
          )}
          ...
          {step === 'supply' && (
            <div className="space-y-4">
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-400">
                  正在存入 {amount} USDT 到 Compound 协议
                </p>
              </div>
            </div>
          )}
